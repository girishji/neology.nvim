...
function M.setup(opts)
  ...
  local highlights = {
    ...
    Identifier                = { fg = c.fg },
    Ignore                    = { fg = c.bg },
    IncSearch                 = { fg = c.bg, bg = c.fg_overlay2 },
    ...
    Search                    = { bg = c.bg_overlay1, gui = 'bold' },
    ...
    TabLineSel                = { fg = c.fg, bg = c.primary, gui = 'bold' },
    Tag                       = { link = 'Special' },
    Title                     = { fg = c.fg_overlay1, gui = 'bold' },
    Todo                      = { fg = c.primary, gui = 'underline' },
    ...
    StatusLineTermNC          = { fg = c.bg, bg = c.primary },
    ...
    DiagnosticUnderlineWarn   = { gui = 'undercurl', sp = c.fg_yellow },
    ...
    -- which-key.nvim
    WhichKey                  = { bg = c.bg, fg = c.primary, gui = 'bold' },
    ...
    -- indent-blankline
    IndentBlanklineIndent1    = { fg = c.bg_overlay1, gui = 'nocombine' },
    ...
    -- Lazy
    LazyProgressDone          = { gui = 'bold', fg = c.primary },
